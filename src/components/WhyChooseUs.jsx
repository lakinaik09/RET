...
const WhyChooseUs = () => {
  return (
    <>
      ...
      <h3 className="md:text-3xl text-xl font-bold text-slate-700 dark:text-slate-300 md:pb-4 pb-2 font-Krub md:px-16 px-6">
        Why Choose RET?
      </h3>
      <div className="box-wrapper grid md:grid-cols-2 md:gap-14 gap-10 md:mb-12 md:px-16 px-6">
        <motion.div
          initial={{ y: 50, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.9 }}
          className="bg-white dark:bg-slate-800 p-4 rounded-md text-center"
        >
