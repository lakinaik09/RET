...
const ValueCard = ({img, title, description}) => {
  return (
   <>
        ...
        className="bg-white dark:bg-slate-800 rounded-md shadow-md md:p-4 p-2 md:w-[18rem] hover:shadow-xl hover:scale-110 duration-300">
            <div className="text-center">
                ...
                <p className="text-base dark:text-slate-300">{description}</p>
            </div>
